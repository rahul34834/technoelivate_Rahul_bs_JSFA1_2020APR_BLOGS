<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <% String s=(String)request.getAttribute("food"); %>
<!DOCTYPE html>
<html>
<head>
...
<body>
<h1>Welcome to the Food Industry!!!!!!</h1>
<%if(s !=null) %>
<h2>The food that you chose is = <%= s %></h2>
<img alt="" src="https://media.istockphoto.com/photos/composition-with-common-food-allergens-picture-id1263666425?b=1&k=6&m=1263666425&s=170667a&w=0&h=w5GRpDEFrrv6w6XxSB7IxYQGeHXz8WudMk5gtNapuTE=">
<br>
